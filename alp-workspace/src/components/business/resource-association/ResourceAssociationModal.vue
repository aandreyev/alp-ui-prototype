          ...
          <div class="search-filters">
            ...
            <div class="filters">
              <select v-model="selectedType" class="filter-select">
                ...
                <option value="folder">VD Folders</option>
              </select>
        ...
        <div v-if="activeTab === 'create'" class="create-new-tab">
          <div class="create-placeholder">
            ...
            <p class="placeholder-description">
              Resource creation workflow will be integrated in Phase 3
            </p>
...
import offeringResourcesData from '@/alp-data/resources/offering-resources.json'
...
const typeFilters = ref<string[]>(['document', 'url', 'form', 'email', 'video'])
...
const loadResources = () => {
  // Load mock resources - flatten the structure
  const flattenedResources: Resource[] = []
  offeringResourcesData.forEach(item => {
    flattenedResources.push(...item.resources as Resource[])
  })
  
  allResources.value = flattenedResources
